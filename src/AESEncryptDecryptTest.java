public class AESEncryptDecryptTest {
  ...
  public static void main(String[] args) {
    ...
    String secretKey = "Define your secret key and salt (keep these secure and don't hardcode in production)";
    String salt = "MySalt";

    // String to be encrypted
    String originalString = "BMA123!thisispasswordforencrypt";
